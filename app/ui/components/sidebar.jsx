...
const SidebarTrigger = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    ...
    >
      {state === "collapsed" ? (
        <PanelLeftOpen className="text-gray-800" size={28} />
      ) : (
        <PanelLeftClose className="text-gray-800" size={28} />
      )}
...
const SidebarHeader = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 pr-2 group-data-[collapsible=icon]:p-2", className)}
      {...props}
    />
  );
});
...
const SidebarFooter = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 pb-6 group-data-[collapsible=icon]:pl-2", className)}
      {...props}
    />
  );
});
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 p-2 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:pl-3",
        className,
      )}
      {...props}
    />
